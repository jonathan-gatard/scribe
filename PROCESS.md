...
2.  **Test Locally**: 
    ...
    - Run tests: `./venv/bin/pytest` or `pytest`.
    - **CRITICAL**: Code must pass ALL tests and linting before pushing.
...
## 3. Environment
- **Virtual Env**: Use `venv` folder for running tests to avoid polluting system Python.
